...
public enum Asn1TypeName {
	...
	CTX_SPECIFIC_00(128), CTX_SPECIFIC_01(129), CTX_SPECIFIC_02(130),
    CTX_SPECIFIC_03(131), CTX_SPECIFIC_04(132), CTX_SPECIFIC_05(133),
    CTX_SPECIFIC_06(134), CTX_SPECIFIC_07(135),
	...
	//这两个都表示的是时间值
	UTC_TIME(23), GENERAL_TIME(24);

	//类型的编号
	private int tagNum;
	
	Asn1TypeName(int tagNum) {
	    this.tagNum = tagNum;
	}
